...
(function() {
  ...
  define('views/table',['underscore', 'jquery', 'backbone', 'services/split_table', 'services/sorting', 'services/resizing_grid', 'services/resizing', 'services/column_reordering', 'templates/_sort_block'], function(_, $, Backbone, SplitTable, Sorting, ResizingGrid, Resizing, ColumnReordering, sortTemplate) {
    var TableView, _ref;
    return TableView = (function(_super) {
      ...
      TableView.prototype.initialize = function() {
        ...
        return $(window).resize(debounceSize);
      };
