  ...
  define('services/split_table',['underscore'], function(_) {
    ...
    return SplitTable = (function() {
      function SplitTable(container, tableHtml, tableDefaults, model, before) {
        ...
        if (!((_ref1 = this.model.get('calculated_dimensions')) != null ? _ref1.headers : void 0) && containerWidth > totWidth) {
          widths = this._autoExpandWidths(widths, containerWidth / totWidth);
        }
