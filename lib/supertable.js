  ...
  define('services/split_table',['underscore'], function(_) {
    ...
    return SplitTable = (function() {
      function SplitTable(container, tableHtml, tableDefaults, model, before) {
        ...
        var bodyHeights, headHeights, table, thead, widths, _ref;
        ...
        _ref = this._countDims(table), widths = _ref[0], headHeights = _ref[1], bodyHeights = _ref[2];
      ...
      SplitTable.prototype._countDims = function(table) {
        var bodyHeights, cell, div, headHeights, row, widths, _i, _len, _ref;
        div = this._preRender();
        ...
        headHeights = (function() {
          ...
          _ref1 = table.querySelectorAll('thead tr');
          _results = [];
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            row = _ref1[_j];
            _results.push(this._elHeight(row));
          }
          return _results;
        }).call(this);
        bodyHeights = (function() {
          var _j, _len1, _ref1, _results;
          _ref1 = table.querySelectorAll('tbody tr');
          _results = [];
          for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
            row = _ref1[_j];
            _results.push(this._elHeight(row));
