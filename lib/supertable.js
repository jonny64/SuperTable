(function(root, factory){if(typeof define === 'function' && define.amd){define([], factory);}else{root.SuperTable = factory();}}(this, function() {
/**
...
define("backbone", ["underscore","jquery","jquery.role","jquery.spin"], (function (global) {
    return function () {
        var ret, fn;
  ...
  define('models/table',['underscore', 'backbone'], function(_, Backbone) {
    ...
    return TableModel = (function(_super) {
      ...
      TableModel.prototype.parse = function(resp, options) {
        ...
        if (resp.columns) {
          resp.order = this.extractOrder(resp.columns);
        }
        return resp;
      };
  ...
  define('services/split_table',['underscore'], function(_) {
    ...
    return SplitTable = (function() {
      function SplitTable(container, tableHtml, tableDefaults, model, before) {
        this._countWidths = __bind(this._countWidths, this);
        ...
        if (!((_ref = this.model.get('calculated_dimensions')) != null ? _ref.headers : void 0)) {
          ...
          widths = this._countWidths(table);
        }
        this.top = this._splitTable(table.querySelector('thead'), widths, tableDefaults.scrollBarWidth);
        this.bottom = this._splitTable(table.querySelector('tbody'), widths);
      }
      ...
      SplitTable.prototype._splitTable = function(table, widths, scrollWidth) {
        ...
        if (table) {
          ...
          _(table.querySelectorAll('tr')).each(function(tr) {
            var flag, ind, rowHeight, trLeft, trRight;
            trLeft = tr.cloneNode();
            trRight = tr.cloneNode();
            rowHeight = tr.className === 'st-table-widths-row' ? 0 : _this.tableDefaults.rowHeight;
      ...
      SplitTable.prototype._insertWidthRulers = function(table) {
        var cell, className, col, cols, i, ind, splitAt, tableWidth, tbody, tdB, tdH, thead, trB, trH, _i, _j, _len, _ref, _ref1, _results;
        tableWidth = 0;
        splitAt = 0;
        col = 0;
        ...
        for (i = _j = 0, _ref1 = tableWidth - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
          ...
          _results.push(tdB.className = className);
        }
        return _results;
      };
      ...
      SplitTable.prototype._countWidths = function(table) {
        var cell, div, result, _i, _len, _ref;
        div = this._preRender();
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          cell = _ref[_i];
          if (cell.className !== 'freezbar-cell') {
            result.push(this._elWidth(cell));
          }
        }
  ...
  define('templates/_sort_block',['jquery', 'underscore'], function($, _) {
    return function(context) {
      ...
      render = function() {
        var $o;
        $o = [];
        $o.push("<div class='st-sort-block'>\n  <span data-order-dir='asc' title='сортировать по возрастанию'>\n    &#9650;\n  </span>\n  <span data-order-dir='desc' title='сортировать по убыванию'>\n    &#9660;\n  </span>\n</div>");
...
(function() {
  ...
  define('views/table',['underscore', 'backbone', 'services/split_table', 'services/sorting', 'services/resizing_grid', 'services/resizing', 'services/column_reordering', 'templates/_sort_block'], function(_, Backbone, SplitTable, Sorting, ResizingGrid, Resizing, ColumnReordering, sortTemplate) {
    var TableView, _ref;
    return TableView = (function(_super) {
      ...
      TableView.prototype.el = '@table-container';
      ...
      TableView.prototype.initialize = function() {
        ...
        this.listenTo(this.model, 'change', function(model) {
          if (model.changed.data) {
            return _this._renderContainer(model.get('data'));
          }
        });
      ...
      TableView.prototype.insertSortBlocks = function(container) {
        var tds;
      ...
      TableView.prototype._setPanesSize = function() {
        var borderWidth, leftBordersWidth, paneHeight, paneStyle, rightPaneWidth, scrollWidth;
        ...
        rightPaneWidth = _.min([this.containerWidth - this.leftWidth, this.rightWidth + scrollWidth]);
        ...
        paneStyle = getComputedStyle(this.headerLeftPane, null);
        ...
        return this.tableRightViewport.style.height = "" + paneHeight + "px";
      };
...
(function() {
  ...
  define('views/header',['backbone', 'templates/header'], function(Backbone, template) {
    var FooterView, _ref;
    return FooterView = (function(_super) {
      ...
      FooterView.prototype.el = '@header';
      ...
      FooterView.prototype._onClickMore = function(e) {
        ...
        this._disableMore();
        return this.options.app.trigger('more-button:click');
      };
      ...
      FooterView.prototype._onClickNext = function(e) {
        ...
        return this.options.app.trigger('next-page:click');
      };
      ...
      FooterView.prototype._onClickPrev = function(e) {
        ...
        return this.options.app.trigger('prev-page:click');
      };
      ...
      FooterView.prototype.disableNext = function() {
        return this.$nextPage.addClass('disabled');
      };

      FooterView.prototype.enableNext = function() {
        return this.$nextPage.removeClass('disabled');
      };

      FooterView.prototype.disablePrev = function() {
        return this.$prevPage.addClass('disabled');
      };

      FooterView.prototype.enablePrev = function() {
        return this.$prevPage.removeClass('disabled');
      };
  ...
  define('services/table_state',['underscore', 'backbone'], function(_, Backbone) {
    ...
    return TableState = (function() {
      function TableState(options) {
        ...
        this.app = options.app, this.el = options.el, this.table = options.table;
      }

      TableState.prototype.columns = function() {
        var leftHeader, rightHeader;
        leftHeader = this.el.querySelector('.st-table-header-left-pane table.st-fixed-table-left');
        rightHeader = this.el.querySelector('.st-table-header-right-pane table.st-fixed-table-right');
...
(function() {
  ...
  define('services/table_api',['underscore', 'backbone'], function(_, Backbone) {
    ...
    return TableAPI = (function() {
      ...
      TableAPI.prototype.getPage = function(start, type) {
        if (start == null) {
          start = 0;
        }
      ...
      TableAPI.prototype._fetchPage = function(options) {
        ...
        this.table.set('fetchType', options.type);
      ...
      TableAPI.prototype._apiUrl = function(index) {
        return this.table.url.replace('#{page}', index);
      };
  ...
  define('app',['underscore', 'backbone', 'models/table', 'views/layout', 'services/table_state', 'services/table_api'], function(_, Backbone, TableModel, LayoutView, TableState, TableAPI) {
    ...
    return App = (function() {
      ...
      App.prototype.initialize = function(options) {
        ...
        _.extend(this, Backbone.Events);
        this.log("app starting version " + this.version + "...");
        if (!options.tableUrl) {
...
(function() {
  ...
  require.config({
    ...
    shim: {
      ...
      backbone: {
        deps: ['underscore', 'jquery', 'jquery.role', 'jquery.spin'],
        exports: 'Backbone'
      }
    },
    paths: {
